...
class L10nTh extends L10n {
  ...
  String foundInDatabase(String name) {
    return '✅ พบในฐานข้อมูล — ข้อมูลโภชนาการเติมอัตโนมัติ';
  }
  ...
  String greetingCalorieSummary(
    ...
    return 'สวัสดีค่ะ วันนี้ช่วยอะไรได้บ้าง? ตอนนี้คุณเหลือแคลอรี่ให้ทานอีก $remaining kcal ทานโปรตีน ${protein}g คาร์บ ${carbs}g ไขมัน ${fat}g ทานอะไรเล่าให้ฉันฟัง แยกเป็นมื้อๆ มาทีเดียวได้เลยค่ะ ดิฉันจะแยกเป็นรายการๆ และบันทึกให้เองค่ะ';
  }
