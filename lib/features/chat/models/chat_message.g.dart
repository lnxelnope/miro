...
int _chatMessageEstimateSize(
  ...
  {
    final value = object.cardDataJson;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
  ...
  {
    final value = object.detectedIntent;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _chatMessageSerialize(
  ...
  writer.writeString(offsets[1], object.cardDataJson);
  writer.writeDouble(offsets[2], object.confidence);
  writer.writeString(offsets[3], object.content);
  writer.writeDateTime(offsets[4], object.createdAt);
  writer.writeString(offsets[5], object.detectedIntent);
  writer.writeString(offsets[6], object.responseType);
...
ChatMessage _chatMessageDeserialize(
  ...
  object.actionsJson = reader.readStringOrNull(offsets[0]);
  object.cardDataJson = reader.readStringOrNull(offsets[1]);
  object.confidence = reader.readDoubleOrNull(offsets[2]);
  object.content = reader.readString(offsets[3]);
  object.createdAt = reader.readDateTime(offsets[4]);
  object.detectedIntent = reader.readStringOrNull(offsets[5]);
  object.id = id;
  object.responseType = reader.readStringOrNull(offsets[6]);
  object.role =
      _ChatMessageroleValueEnumMap[reader.readByteOrNull(offsets[7])] ??
          MessageRole.user;
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'cardDataJson',
      ));
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      cardDataJsonIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'cardDataJson',
      ));
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      cardDataJsonContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'cardDataJson',
        value: value,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      cardDataJsonMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'cardDataJson',
        wildcard: pattern,
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByActionsJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'actionsJson', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByActionsJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'actionsJson', Sort.desc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByCardDataJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardDataJson', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortByCardDataJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardDataJson', Sort.desc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByConfidence() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'confidence', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByConfidenceDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByDetectedIntent() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByResponseType() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByActionsJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'actionsJson', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByActionsJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'actionsJson', Sort.desc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByCardDataJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardDataJson', Sort.asc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      thenByCardDataJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardDataJson', Sort.desc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByConfidence() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'confidence', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByConfidenceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'confidence', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByDetectedIntent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'detectedIntent', Sort.asc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByResponseType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'responseType', Sort.asc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByActionsJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByCardDataJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'cardDataJson', caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByConfidence() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByDetectedIntent(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByResponseType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations> actionsJsonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'actionsJson');
    });
  }

  QueryBuilder<ChatMessage, String?, QQueryOperations> cardDataJsonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'cardDataJson');
    });
  }

  QueryBuilder<ChatMessage, double?, QQueryOperations> confidenceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations> responseTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'responseType');
    });
  }

  QueryBuilder<ChatMessage, MessageRole, QQueryOperations> roleProperty() {
    return QueryBuilder.apply(this, (query) {
...
ChatSession _chatSessionDeserialize(
  ...
  object.id = id;
  object.sessionId = reader.readStringOrNull(offsets[1]);
