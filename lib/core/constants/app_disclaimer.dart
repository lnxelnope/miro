/// Health and liability disclaimer for ArCal app
class AppDisclaimer {
  AppDisclaimer._();

  /// Short disclaimer for inline display
  static const String short = 'ArCal is an informational tool only. '
...
ArCal is a nutrition tracking and analysis tool designed for informational and personal reference purposes only. The data, estimates, and analyses provided by ArCal — including AI-generated nutritional information — are approximations and should NOT be considered as medical advice, dietary prescriptions, or professional health recommendations.

ArCal is NOT a licensed healthcare provider, dietitian, or nutritionist. The information presented within this application is intended to assist users in tracking and understanding their dietary intake, and should be used solely as a supplementary reference for the user's own analysis and decision-making.
...
By using ArCal, you acknowledge and agree that all nutritional data is provided on an "as-is" basis without warranty of accuracy, completeness, or fitness for any particular purpose.

ArCal, its developers, and affiliated parties assume no responsibility or liability for any consequences resulting from the use of this application or reliance on the information provided.
