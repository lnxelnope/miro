...
class TdeeCalculator {
  ...
  static double activityMultiplier(String level) {
    switch (level) {
      case 'sedentary':
        return 1.2; // นั่งทั้งวัน
      case 'light':
        return 1.375; // ออกกำลังกายเบาๆ 1-3 วัน/สัปดาห์
      case 'moderate':
        return 1.55; // ออกกำลังกาย 3-5 วัน/สัปดาห์
      case 'active':
        return 1.725; // ออกกำลังกายหนัก 6-7 วัน/สัปดาห์
      case 'very_active':
        return 1.9; // ออกกำลังกายหนักมาก + งานที่ต้องใช้แรง
      default:
        return 1.55; // default: ปานกลาง
    }
  }
  ...
  static List<Map<String, String>> activityLevels = [
    {
      'key': 'sedentary',
      'th': 'นั่งทั้งวัน (ไม่ออกกำลังกาย)',
      'en': 'Sedentary'
    },
    {
      'key': 'light',
      'th': 'ออกกำลังกายเบา (1-3 วัน/สัปดาห์)',
      'en': 'Lightly Active'
    },
    {
      'key': 'moderate',
      'th': 'ออกกำลังกายปานกลาง (3-5 วัน)',
