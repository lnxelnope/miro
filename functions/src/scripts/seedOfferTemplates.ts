...
const TEMPLATES = [
  ...
  {
    slug: "gold_tier_freepass",
    triggerEvent: "tier_up",
    triggerCondition: { tier: "gold" },
    title: { en: "🏆 Gold Tier Reward!", th: "🏆 รางวัล Gold Tier!" },
    description: {
      en: "You've reached Gold! Enjoy 3 days of free AI usage.",
      th: "คุณถึง Gold แล้ว! ใช้ AI ฟรี 3 วัน",
    },
    ctaText: { en: "Claim Freepass", th: "รับ Freepass" },
    icon: "🏆",
    rewardType: "freepass",
    rewardConfig: { days: 3 },
