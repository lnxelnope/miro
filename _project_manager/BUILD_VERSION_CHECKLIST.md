...
- [x] **pubspec.yaml** - Version format ถูกต้อง (`1.1.14+39`)
- [x] **android/app/build.gradle.kts** - Version sync ตรงกัน (`versionCode = 39`, `versionName = "1.1.14"`)
- [x] **lib/features/profile/presentation/profile_screen.dart** - Version display in Settings (`'1.1.14'`)
- [x] **Google Play Billing Library** - รองรับ 7.0+ (ใช้ 7.1.1)
- [x] **Target SDK** - 35 (Android 15)
- [x] **Compile SDK** - 36 (Android 16)
- [x] **Version Naming** - ตาม Semantic Versioning
